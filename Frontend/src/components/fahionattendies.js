...
export default function Fahionattendies() {
  ...
  try{
    if(Number.length > 9){
    var data1 = await fetch("http://localhost:5000/Order5",{
      method: 'POST',
  ...
  const rzp1 = new window.Razorpay(options);
    ...
    const saveDataToDatabase = async () => {
      ...
      try {
        ...
        const response = await fetch("http://localhost:5000/saveDataToDatabase5", {
          method: "POST",
          headers: {
      ...
      <div>
          <div className="container-fluid pb-5" style={{width:'100vw' , height:'auto' , background:'#fff'}}>
              <div className="mainbox d-flex">
                  ...
                  <Link to="/fashiondesigner" style={{fontSize:'25px' , borderBottom:'1px solid pink'}}>Register for Fashion Designer</Link>
                </div>
                ...
                <div className="links mt-5 ml-2">
                  ...
                  <div className="rightbox w-50 mt-5">
                      ...
                      <div className="price mt-3">
                       <span><del>₹999</del></span>   <span style={{fontSize:'25px' , fontWeight:'900' , color:'#fc0c8c'}}>₹799</span>
                      </div>
              ...
              <div className="forms mt-5">
                      <div className="formbox" style={{width:'100%' , height:'70px' , borderTopLeftRadius:'25px' , borderTopRightRadius:'25px' , background:'#fc0c8c' , textAlign:'center'}}>
                         <span className="" style={{color:'white' , fontSize:'25px' , fontWeight:'700'}}>Attendees</span>     
                      </div>
                      <div className="formbox" style={{width:'100%' , height:'400px' , borderBottomLeftRadius:'25px' , borderBottomRightRadius:'25px'}}>
                      <Form onSubmit={(e) => { e.preventDefault(); checkout(799); }} style={{margin:'0' , maxWidth:'100%'}}>
